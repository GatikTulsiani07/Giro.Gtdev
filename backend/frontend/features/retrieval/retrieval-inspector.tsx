import { BarChart3, Database, ExternalLink, FileCode2, Link2, SearchX, X } from "lucide-react";
  ...
  return (
    <aside className="flex h-full min-h-0 w-full flex-col border-l border-border-subtle bg-panel" aria-label="Retrieval inspector">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto">
        {loading ? <div className="space-y-2 p-3" aria-label="Loading retrieval inspector"><Skeleton className="h-10" /><Skeleton className="h-9" /><Skeleton className="h-9" /><Skeleton className="h-32" /></div> : null}
