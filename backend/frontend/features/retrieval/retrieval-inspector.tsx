  ...
  return (
    <aside className="flex h-full min-h-0 w-full flex-col border-l border-border-subtle bg-panel" aria-label="Retrieval inspector">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto">
        ...
        {!loading && !error && !retrieval ? <EmptyState compact headingLevel={3} icon={SearchX} title="No retrieval run yet" description="Ask a question to inspect ranking signals and retrieved chunks." /> : null}
        {retrieval ? <>
