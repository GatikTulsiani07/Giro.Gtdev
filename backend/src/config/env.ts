...
const EnvSchema = z
  .object({
    ...
    AGENT_RUNTIME_MAX_ACTIVE: z.coerce.number().int().min(1).max(10_000).default(100),
    AGENT_RUNTIME_MAX_LEASED: z.coerce.number().int().min(1).max(10_000).default(50),
    AGENT_RUNTIME_MAX_DURATION_MS: z.coerce.number().int().min(1_000).max(604_800_000).default(120_000),
    AGENT_RUNTIME_MAX_RETRIES: z.coerce.number().int().min(0).max(20).default(2),
    AGENT_RUNTIME_MAX_OUTPUT_BYTES: z.coerce.number().int().min(1_024).max(1_073_741_824).default(1_048_576),
    AGENT_RUNTIME_MAX_CONCURRENT_AGENTS: z.coerce.number().int().min(1).max(10_000).default(50),
    AGENT_RUNTIME_RETENTION_COUNT: z.coerce.number().int().min(1).max(100_000).default(100),
    AGENT_RUNTIME_LEASE_MS: z.coerce.number().int().min(1_000).max(3_600_000).default(60_000),
